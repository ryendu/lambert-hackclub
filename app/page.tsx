    ...
    <main className="flex min-h-screen flex-col items-center justify-between p-16">
      ...
      <div className="gap-6 flex flex-col ">
        <div className="flex flex-row gap-6 flex-wrap min-[1070px]:flex-nowrap items-stretch self-stretch">
          <div className="rounded-[29px] min-w-[660px] self-stretch ">
            <MagicCard
          ...
          <div className="rounded-[29px] min-w-[300px] self-stretch flex grow ">
            <MagicCard
        ...
        <div className="flex flex-row gap-6 flex-wrap min-[1070px]:flex-nowrap items-stretch self-stretch max-h-96">
          <div className="rounded-[29px] min-w-[300px] self-stretch grow flex">
            <MagicCard
          ...
          <div className="rounded-[29px] min-w-[300px] self-stretch flex">
            <MagicCard
              className="flex justify-between rounded-[29px] flex-col p-7 gap-4 bg-[#ffffff]"
              gradientColor="#F5F5F5"
            >
          ...
          <div className="rounded-[29px] min-w-[300px] self-stretch flex">
            <MagicCard
              className="flex justify-between rounded-[29px] flex-col p-7 gap-4 bg-[#FCF4FD]"
              gradientColor="#FCE4FF"
            >
              <h1 className="text-3xl lg:text-4xl text-[#742294] font-bold text-left">
                Come to our first meeting heha heheha
              </h1>

              <p className="py-4 xl:mr-12 text-lg">
                August 28th at 7:45 am in Mr. Fuqua’s Room 12xx
              </p>
